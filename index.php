...
<head>
    ...
    <link rel="shortcut icon" href="img/PNP.png" type="image/x-icon">
...
<style>
    #overview {
        background-image: url('img/ilustrasikerjasama.jpeg');
...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top" style="height: 70px;">
        <div class="container">
            <a class="navbar-brand" href="#">SIKERMA PNP</a>
    ...
    <section id="overview" class="d-flex align-items-center justify-content-center text-center text-white"
        ...
        <div class="container">
            ...
            <a href="login.php" class="btn btn-lg mt-3" style="background-color: #de6e24; color: white;"><i class="bi bi-box-arrow-in-right"></i> Masuk</a>
        </div>
    </section>
